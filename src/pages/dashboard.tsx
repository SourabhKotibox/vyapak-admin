...
import {
  ...
  CalendarRange, RefreshCw, RotateCcw, CreditCard,
...
export default function Dashboard() {
  ...
  const statCards = [
    ...
    { title: "Total Revenue", value: formatStatRevenue(stats?.totalRevenue), icon: TrendingUp, sub: "All revenue sources", highlight: true },
  ];
                ...
                <tbody>
                  {transactionsData.map((t: any, i: number) => (
                    <tr key={i} className="border-b border-border/50 hover:bg-muted/30 transition-colors">
                      ...
                      <td className="py-2.5 px-2">
                        <span className={`inline-flex items-center gap-1 px-1.5 py-0.5 rounded-full text-[9px] font-semibold bg-purple-500/10 text-purple-400`}>
