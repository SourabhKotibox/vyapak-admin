        ...
        {activeTab === "Episode Details" && (
          <div className="p-6 space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
              ...
              <div className={`col-span-full rounded-xl border-2 p-4 transition-colors ${isFree ? 'border-border/40 opacity-50' : 'border-border bg-muted/20'}`}>
                <div className="flex items-start justify-between gap-4">
                  <div className="flex-1">
                    ...
                    <p className="text-xs text-muted-foreground/80 mt-1">
                      {isFree
                        ? "Free episodes are not locked."
                        : "Locked episodes require an active subscription to unlock."}
                    </p>
                  </div>
                </div>
              </div>
