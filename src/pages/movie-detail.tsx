      ...
      <div className="relative w-full overflow-hidden" style={{ minHeight: 480, maxHeight: 620 }}>
        ...
        <div className="flex items-center gap-3 flex-wrap">
          ...
          <button
            ...
            style={{ background: "linear-gradient(135deg, #E1BA53 0%, #b9090b 100%)", boxShadow: "0 8px 24px rgba(229,9,20,0.3)" }}
          >
        ...
        return (
          <div className="pb-10">
            ...
            <div className="flex items-center gap-3 mb-5 px-6 sm:px-10 lg:px-16">
              <div className="w-1 h-6 rounded-full flex-shrink-0" style={{ background: "#E1BA53" }} />
