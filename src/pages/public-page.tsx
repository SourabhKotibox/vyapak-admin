...
export default function PublicPagePage() {
  ...
  useEffect(() => {
    if (page) {
      document.title = page.metaTitle || `${page.title} | Vyzpak`;
      ...
      metaDesc.setAttribute('content', page.metaDescription || `Read ${page.title} on Vyzpak.`);
      ...
      if (ogDesc) ogDesc.setAttribute('content', page.metaDescription || `Read ${page.title} on Vyzpak.`);

      const twitterTitle = document.querySelector('meta[name="twitter:title"]');
      if (twitterTitle) twitterTitle.setAttribute('content', page.metaTitle || page.title);

      const twitterDesc = document.querySelector('meta[name="twitter:description"]');
      if (twitterDesc) twitterDesc.setAttribute('content', page.metaDescription || `Read ${page.title} on Vyzpak.`);
    }
  }, [page]);
